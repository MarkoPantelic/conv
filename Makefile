...
LIB = -lm
DBGFLAGS = -g
OBJ = main.o marg.o nsconv.o tempconv.o weights.o chk_inval.o callconvf.o si_system.o non_si_compat.o imperial_system.o unit.o global_def.o us_customary_system.o
VPATH = marg
INCL_DIR = includes
BUILD_DIR := build

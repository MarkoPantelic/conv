...
/* id's of base units */
enum {G_SI_ID=1, KG_SI_ID, METER_SI_ID, SECOND_SI_ID, AMPERE_SI_ID, KELVIN_SI_ID,
      MOLE_SI_ID, CANDELA_SI_ID} ;

/* id's of dervied units */
enum {METER_SQUARE_SI_ID, METER_CUBIC_SI_ID};
